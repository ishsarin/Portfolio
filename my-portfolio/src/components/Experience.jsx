      ...
      <div className="boat">
        ...
        <div className="boat-work">
          <ul>
            ...
            <li>
              - Designed scalable backend logic to handle thousands of
              concurrent bot update requests, improving operational efficiency
              and reducing manual intervention by 80%.
            </li>
            <li>
            ...
            <li>
              - Delivered end-to-end security monitoring and incident response
              for 8+ global clients across multiple domains, leveraging tools
              like Splunk, Sentinel, Defender, and Proofpoint to reduce incident
        ...
        <div className="boat-work">
          <ul>
            <li>
              ...
              library which improved mobile conversion rates by 40% and reduced
              bounce rate by 25%.
            </li>
            <li>
            ...
            <li>
              - Reduced page load speed by 2 seconds, by adding a custom class
              on the images of the products along with cleaning code and making
